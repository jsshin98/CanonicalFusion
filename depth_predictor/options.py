...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_data.add_argument('--dataroot', type=str, default='',
        ...
        g_train.add_argument('--continue_train', action='store_false', help='continue training: load the latest model')

        # Testing related
        g_test = parser.add_argument_group('Testing')
        g_test.add_argument('--resolution', type=int, default=256, help='# of grid in mesh reconstruction')
        g_test.add_argument('--test_folder_path', type=str, default='', help='the folder of test image')
        ...
        parser.add_argument('--load_netG_checkpoint_path', type=str, default='', help='path to save checkpoints')
