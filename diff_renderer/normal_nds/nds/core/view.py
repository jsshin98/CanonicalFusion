...
class View:
    ...
    def __init__(self, normal, mask, color, camera, view_angle=0, view_pose=None, orthographic=False,  smpl_param=None, smpl_model=None, device='cpu'):
    ...
    def load_icon(cls, image_path, scale, center, ortho_ratio=0.4, res=512, view_angle=0, camera_depth=1.6, device='cpu'):
        ...
        return cls(color_world, mask, camera, view_angle=view_angle, orthographic=False, device=device)
    ...
    def load_smpl_mask(cls, smpl_image, scale, center, ortho_ratio=0.4, res=512, view_angle=0, camera_depth=1.6, device='cpu'):
        ...
        camera = Camera(K, R, t, orthographic=False, device=device)
        
        # Extract the mask
        mask = smpl_image[:, :, 3:]

        return cls(smpl_image, mask, camera, view_angle=view_angle, orthographic=False, device=device)
