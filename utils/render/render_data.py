...
def rotate_mesh():
    mesh = o3d.io.read_point_cloud('/home/kekti/3D-reconstruction-2020/dataset/training_dataset/OBJ/SMPLX_0/0.ply')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', type=str, default='/home/keti/3D-reconstruction-2020/dataset/SMPLX_dataset')
    parser.add_argument('-o', '--out_dir', type=str, default='/home/keti/3D-reconstruction-2020/dataset/training_dataset_SMPLX')
